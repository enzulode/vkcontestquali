...
/**
 * This file was cloned from androidx/compose/foundation/RowColumnImpl.kt, with
 * slight modifications for Relay.
 */
...
internal fun rowColumnMeasurePolicy(
    ...
    crossAxisAlignmentImpl: CrossAxisAlignmentImpl
): MeasurePolicy {
        ...
        override fun MeasureScope.measure(
            ...
            if (anyAlignBy) {
                for (i in placeables.indices) {
                    ...
                    val parentData = rowColumnParentData[i]
                    val alignmentLinePosition = parentData.crossAxisAlignmentImpl
            ...
            return layout(layoutWidth, layoutHeight) {
                ...
                placeables.forEachIndexed { index, placeable ->
                    ...
                    val childCrossAlignment = parentData.crossAxisAlignmentImpl
                        ?: crossAxisAlignmentImpl
...
/**
 * [RelayRow] will be [Horizontal], [RelayColumn] is [Vertical].
 */
 ...
 */
@Immutable
internal sealed class CrossAxisAlignmentImpl {
    /**
    ...
    companion object {
         ...
         */
        @Stable
        val Center: CrossAxisAlignmentImpl = CenterCrossAxisAlignmentImpl
        /**
         ...
         */
        @Stable
        val Start: CrossAxisAlignmentImpl = StartCrossAxisAlignmentImpl
        /**
         * Place children such that their end edge is aligned to the end edge of the cross
         * axis. TODO(popam): Consider rtl directionality.
         */
        @Stable
        val End: CrossAxisAlignmentImpl = EndCrossAxisAlignmentImpl

        /**
         * Align children by their baseline.
         */
        fun AlignmentLine(alignmentLine: AlignmentLine): CrossAxisAlignmentImpl =
            AlignmentLineCrossAxisAlignmentImpl(AlignmentLineProvider.Value(alignmentLine))
         ...
         */
        internal fun vertical(vertical: Alignment.Vertical): CrossAxisAlignmentImpl =
            VerticalCrossAxisAlignmentImpl(vertical)

        /**
         * Align children with horizontal alignment.
         */
        internal fun horizontal(horizontal: Alignment.Horizontal): CrossAxisAlignmentImpl =
            HorizontalCrossAxisAlignmentImpl(horizontal)
    }

    private object CenterCrossAxisAlignmentImpl : CrossAxisAlignmentImpl() {
        override fun align(
            size: Int,
            layoutDirection: LayoutDirection,
            placeable: Placeable,
    ...
    private object StartCrossAxisAlignmentImpl : CrossAxisAlignmentImpl() {
        override fun align(
            size: Int,
            layoutDirection: LayoutDirection,
            placeable: Placeable,
    ...
    private object EndCrossAxisAlignmentImpl : CrossAxisAlignmentImpl() {
        override fun align(
            size: Int,
            layoutDirection: LayoutDirection,
            placeable: Placeable,
    ...
    private class AlignmentLineCrossAxisAlignmentImpl(
    ...
    private class VerticalCrossAxisAlignmentImpl(
    ...
    private class HorizontalCrossAxisAlignmentImpl(
...
private val RowColumnParentData?.crossAxisAlignmentImpl: CrossAxisAlignmentImpl?
    get() = this?.crossAxisAlignmentImpl

private val RowColumnParentData?.isRelative: Boolean
    get() = this.crossAxisAlignmentImpl?.isRelative ?: false
...
internal sealed class SiblingsAlignedModifier(
    ...
    internal class WithAlignmentLineBlock(
        ...
        override fun Density.modifyParentData(parentData: Any?): Any {
            return ((parentData as? RowColumnParentData) ?: RowColumnParentData()).also {
                it.crossAxisAlignmentImpl =
                    CrossAxisAlignmentImpl.Relative(AlignmentLineProvider.Block(block))
            }
        }
    ...
    internal class WithAlignmentLine(
        ...
        override fun Density.modifyParentData(parentData: Any?): Any {
            return ((parentData as? RowColumnParentData) ?: RowColumnParentData()).also {
                it.crossAxisAlignmentImpl =
                    CrossAxisAlignmentImpl.Relative(AlignmentLineProvider.Value(alignmentLine))
            }
        }
...
internal class HorizontalAlignModifier(
    ...
    override fun Density.modifyParentData(parentData: Any?): RowColumnParentData {
        return ((parentData as? RowColumnParentData) ?: RowColumnParentData()).also {
            it.crossAxisAlignmentImpl = CrossAxisAlignmentImpl.horizontal(horizontal)
        }
    }
...
internal class VerticalAlignModifier(
    ...
    override fun Density.modifyParentData(parentData: Any?): RowColumnParentData {
        return ((parentData as? RowColumnParentData) ?: RowColumnParentData()).also {
            it.crossAxisAlignmentImpl = CrossAxisAlignmentImpl.vertical(vertical)
        }
    }
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
...
internal data class RowColumnParentData(
    ...
    var crossAxisAlignmentImpl: CrossAxisAlignmentImpl? = null
)
